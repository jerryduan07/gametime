	...
	if (!stable) {
	  //	while (!stable) {
		...
		step++;
		{
			...
			else if(FH_STEUERUNG_DUMMY_FH_STEUERUNG_DUMMY_next_state == 2)/** state BEREIT in chart FH_STEUERUNG_DUMMY **/
				{
					if ((FH_DU__MFHZ && !(FH_DU__MFHZ_old))) {
						stable = 0;
						FH_DU__MFH = -100;
			...
			else if(FH_STEUERUNG_DUMMY_FH_STEUERUNG_DUMMY_next_state == 3)/** state OEFFNEN in chart FH_STEUERUNG_DUMMY **/
				{
					if ((!(FH_DU__MFHA) && FH_DU__MFHA_old)) {
						stable = 0;
						FH_DU__MFH = 0;
...
END:
		...
		/*		generic_KINDERSICHERUNG_CTRL(); -- inlined by sanjit */
	if (SYS_bit_get(Bitlist, active_KINDERSICHERUNG_CTRL_IDX)) {
		if (KINDERSICHERUNG_CTRL_KINDERSICHERUNG_CTRL_next_state == 1) 
			/** state ZENTRAL in chart KINDERSICHERUNG_CTRL **/
			{
				...
				if (ZENTRAL_KINDERSICHERUNG_CTRL_next_state == 1) 
					/** state IN_ZENTRAL in chart KINDERSICHERUNG_CTRL **/
					{
						...
						else if ((FH_TUERMODUL__SFHZ_ZENTRAL && !(FH_TUERMODUL__SFHZ_ZENTRAL_old))) {
							stable = 0;
						...
						else if ((!(FH_TUERMODUL__SFHA_ZENTRAL) && FH_TUERMODUL__SFHA_ZENTRAL_old)) {
							stable = 0;
							FH_TUERMODUL__SFHA_copy = 0;
		...
		else if(KINDERSICHERUNG_CTRL_KINDERSICHERUNG_CTRL_next_state == 2)	/** state MEC in chart KINDERSICHERUNG_CTRL **/
			{
				...
				/** state INMEC in chart KINDERSICHERUNG_CTRL **/
					{
						...
						else if ((FH_TUERMODUL__SFHZ_MEC && !(FH_TUERMODUL__SFHZ_MEC_old))) {
							stable = 0;
							FH_TUERMODUL__SFHZ_copy = 1;
						...
						else if ((!(FH_TUERMODUL__SFHA_MEC) && FH_TUERMODUL__SFHA_MEC_old)) {
							stable = 0;
							FH_TUERMODUL__SFHA_copy = 0;
		...
		else if (KINDERSICHERUNG_CTRL_KINDERSICHERUNG_CTRL_next_state == 3)	/** state WAITING in chart KINDERSICHERUNG_CTRL **/
			{
...
END2:
		...
		/*		generic_FH_TUERMODUL_CTRL();  -- inlined by sanjit */
	...
	if (SYS_bit_get(Bitlist, active_FH_TUERMODUL_CTRL_IDX)) {
		...
		else if(B_FH_TUERMODUL_CTRL_next_state == 3)	/** state INITIALISIERT in chart FH_TUERMODUL_CTRL **/
			{
				if (((FH_TUERMODUL_CTRL__N > 60 && !(FH_TUERMODUL_CTRL__N_old > 60))) && ((!(FH_TUERMODUL_CTRL__INREVERS1 || FH_TUERMODUL_CTRL__INREVERS2)))) {
				...
				else if (((FH_TUERMODUL__BLOCK && !(FH_TUERMODUL__BLOCK_old))) && ((FH_TUERMODUL__MFHA))) {
					stable = 0;
					FH_TUERMODUL__MFHA_copy = 0;
				...
				else if (((FH_TUERMODUL__BLOCK && !(FH_TUERMODUL__BLOCK_old))) && ((FH_TUERMODUL__MFHZ))) {
					stable = 0;
					FH_TUERMODUL__MFHZ_copy = 0;
					...
					if (INITIALISIERT_FH_TUERMODUL_CTRL_next_state == 1)
					{
						...
						if (OEFFNEN_FH_TUERMODUL_CTRL_next_state == 1)
						...
						else if (OEFFNEN_FH_TUERMODUL_CTRL_next_state == 2)
							{
								...
								else if ((!(FH_TUERMODUL__SFHA) && FH_TUERMODUL__SFHA_old)) {
									stable = 0;
									FH_TUERMODUL__MFHA_copy = 0;
				...
				else if(INITIALISIERT_FH_TUERMODUL_CTRL_next_state == 3)
					{
						...
						else if (((FH_TUERMODUL__SFHA && !(FH_TUERMODUL__SFHA_old))) && ((FH_TUERMODUL__POSITION < 405))) {
							stable = 0;
							FH_TUERMODUL__MFHA_copy = 1;
	...
	/* end inline by sanjit */
		...
		/*		generic_EINKLEMMSCHUTZ_CTRL(); -- inlined by sanjit */
	if (SYS_bit_get(Bitlist, active_EINKLEMMSCHUTZ_CTRL_IDX)) {
		...
		else if(EINKLEMMSCHUTZ_CTRL_EINKLEMMSCHUTZ_CTRL_next_state == 2)	/** state EINKLEMMUNG in chart EINKLEMMSCHUTZ_CTRL **/
			{
	...
	/* end inline by sanjit */
		...
		/*		generic_BLOCK_ERKENNUNG_CTRL();  inlined by sanjit */
